...
import '../data/questions_moyen.dart';
import 'niveaux.dart';
import 'resultats.dart';
import 'bible_view.dart'; // 🔹 Import WebView Bible

class QuizMoyenPage extends StatefulWidget {
  const QuizMoyenPage({super.key});

  @override
  State<QuizMoyenPage> createState() => _QuizMoyenPageState();
}

class _QuizMoyenPageState extends State<QuizMoyenPage> {
  ...
  void initState() {
    ...
    selectedQuestions = List<Map<String, dynamic>>.from(questionsMoyen)..shuffle();
