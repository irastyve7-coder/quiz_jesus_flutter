...
import '../data/questions_facile.dart';
import 'niveaux.dart';
import 'resultats.dart';
import 'bible_view.dart'; // 🔹 Import de la page WebView Bible

class QuizFacilePage extends StatefulWidget {
  const QuizFacilePage({super.key});

  @override
  State<QuizFacilePage> createState() => _QuizFacilePageState();
}

class _QuizFacilePageState extends State<QuizFacilePage> {
  ...
  void initState() {
    ...
    selectedQuestions = List<Map<String, dynamic>>.from(questionsFacile)..shuffle();
